...
abstract class BaseRepository
{
    ...
    public function findAllPaginate($conditions = [], $with = [], $paginate = null)
    {
        return $this->getModel()->where($conditions)->with($with)->orderBy('id', 'DESC')->paginate($paginate == null ? self::PAGINATION : $paginate);
    }
